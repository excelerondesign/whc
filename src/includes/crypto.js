...
export class hash {
    constructor() {
        // constants [§4.2.2]
        /** @constant {number[]} K */
        this.K = [0x428a2f98, 0x71374491, 0xb5c0fbcf, 0xe9b5dba5, 0x3956c25b, 0x59f111f1, 0x923f82a4, 0xab1c5ed5,
     ...
     * @param {number} x 
     */
    ROTR(n, x) { return (x >>> n) | (x << (32 - n)); }
    /** @param {number} x */
    Sigma0(x) { return this.ROTR(2, x) ^ this.ROTR(13, x) ^ this.ROTR(22, x); }
    /** @param {number} x */
    Sigma1(x) { return this.ROTR(6, x) ^ this.ROTR(11, x) ^ this.ROTR(25, x); }
    /** @param {number} x */
    sigma0(x) { return this.ROTR(7, x) ^ this.ROTR(18, x) ^ (x >>> 3); }
    /** @param {number} x */
    sigma1(x) { return this.ROTR(17, x) ^ this.ROTR(19, x) ^ (x >>> 10); }
    /**
     * @param {number} x
     * @param {number} y
     * @param {number} z
