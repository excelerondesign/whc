  ...
  function sha256() {
    ...
    this._computeHash = function ({
      ...
      for (var i = 0; i < N; i++) {
        ...
        for (var t = 16; t < 64; t++) W[t] = this._sigma1(W[t - 2]) + W[t - 7] + this._sigma0(W[t - 15]) + W[t - 16] & 0xffffffff; // 2 - initialise working variables a, b, c, d, e, f, g, h with previous hash value
    ...
    this.hash = function (msg) {
      ...
      const intermediateHash = this._computeHash(encodedMessage, this.H, this.K);
